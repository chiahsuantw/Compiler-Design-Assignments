...
class Grader:
    ...
    CASES: Dict[CaseType, Dict[int, str]] = {
        CaseType.BASIC: {
            ...
            2: "02_redecl",
            3: "03_variable",
            4: "04_VariableReference",
            5: "05_BinaryOperator",
            6: "06_UnaryOperator",
            7: "07_FunctionInvocation",
            8: "08_PrintStatement",
            9: "09_ReadStatement",
            10: "10_assignment",
            11: "11_condition",
        ...
        CaseType.HIDDEN: {
            ...
            2: "102_redecl",
            3: "103_variable",
            4: "104_VariableReference",
            5: "105_BinaryOperator",
            6: "106_UnaryOperator",
            7: "107_FunctionInvocation",
            8: "108_PrintStatement",
            9: "109_ReadStatement",
            10: "110_assignment",
            11: "111_condition",
            12: "112_ForLoop",
    ...
    CASE_SCORES: Dict[CaseType, List[float]] = {
        CaseType.BASIC: [UNUSED, 5, 4.5, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2.5, 2.5],
        CaseType.ADVANCE: [UNUSED],
        CaseType.HIDDEN: [UNUSED, 5, 4.5, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2.5, 2.5],
    }
